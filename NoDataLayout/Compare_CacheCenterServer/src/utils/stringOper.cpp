...
string intxy2String(string filename, int sx, int sy, int ex,int ey){
	...
	outstrStream<<filename<<"_"<<sx<<"_"<<sy<<"_"<<ex<<"_"<<ey<<".fits";
	string strFITS = outstrStream.str();
	cout<<"strFITSstrFITSstrFITSstrFITSstrFITSstrFITSstrFITSstrFITSstrFITS"<<strFITS<<endl;
